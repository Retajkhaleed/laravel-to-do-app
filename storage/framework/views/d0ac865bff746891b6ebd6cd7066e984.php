...
<head>
  ...
  <title><?php echo $__env->yieldContent('title','Todo'); ?></title>
...
<div class="container">
  ...
  <div class="topbar">
    ...
    <a class="btn btn-primary" href="<?php echo e(route('tasks.index')); ?>">All Tasks</a>
  </div>
...
</html><?php /**PATH C:\laragon\www\todo\resources\views/tasks/app.blade.php ENDPATH**/ ?>